...
export default function FloatingLines({
  ...
  }, [animationSpeed, bendRadius, bendStrength, bottomLineCount, bottomLineDistance, bottomWavePosition, enabledWaves, interactive, lineCount, lineDistance, linesGradient, middleLineCount, middleLineDistance, middleWavePosition, mouseDamping, parallax, parallaxStrength, topLineCount, topLineDistance, topWavePosition]);

  return <div ref={containerRef} className={`floating-lines-container ${className}`.trim()} style={{ mixBlendMode }} />;
}
